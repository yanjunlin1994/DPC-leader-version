...
// }
//update the time for last hearing from a message from a node
...
//get the last time we heard from a node
...
func (self *Node) updateVersions(NSVersion uint64) {
